...
yolov11_detector = YOLO("yolov11y_0.797R.pt")
...
for i, frame in enumerate(video):
    # Get ball detections (class_id=0)
    ball_detections = get_detections(yolov11_detector, frame, class_id=0, confidence_threshold=0.3)
    # Get player detections (class_id=1)
    player_detections = get_detections(yolov11_detector, frame, class_id=1, confidence_threshold=0.35)
    # Combine detections
    detections = ball_detections + player_detections

    # Update trackers and perform additional processing...
