...
# TRACKING
results_tracking, motion_estimators, coord_transformations, video = measure_time(process_video, r"resources\yolo8.pt", r"resources\manc.mp4", 10, 10, process_name="Tracking")
